...
- Managed high-net-worth portfolios totaling over $50M, achieving a 22% increase in asset value
- Led a team of 8 professionals, consistently surpassing quarterly sales and service goals
- Developed and implemented client retention strategies that improved satisfaction scores by 27%
- Streamlined operational processes, reducing transaction processing time by 30%
- Recognized as "Manager of the Year" for two consecutive years (2019, 2020)
...
### Cashier
**KRIF Ghana Ltd.** | Accra, Ghana  
*2010–2012*

- Managed daily transactions with precision, ensuring accuracy in retail operations
- Balanced cash drawers with 100% accuracy and maintained detailed financial records
- Provided exceptional customer service, contributing to increased customer satisfaction
- Assisted in inventory management and product restocking
